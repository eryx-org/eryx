...
## `eryx-wasm-runtime` - [0.3.0](https://github.com/eryx-org/eryx/releases/tag/eryx-wasm-runtime-v0.3.0) - 2026-02-08
...
## `eryx-python` - [0.3.0](https://github.com/eryx-org/eryx/releases/tag/eryx-python-v0.3.0) - 2026-02-08

### Added
- *(output)* stream stdout/stderr in real-time via report-output WIT import ([#75](https://github.com/eryx-org/eryx/pull/75))
- *(volumes)* add host filesystem volume mounts ([#71](https://github.com/eryx-org/eryx/pull/71))
- *(python)* switch snapshot/restore serialization from pickle to dill ([#72](https://github.com/eryx-org/eryx/pull/72))
- *(python)* add CLI for running sandboxed Python from the terminal ([#70](https://github.com/eryx-org/eryx/pull/70))
...
### Other
- *(python)* add mise tasks for building and testing Python package ([#74](https://github.com/eryx-org/eryx/pull/74))
- *(python)* add networking and callbacks documentation ([#56](https://github.com/eryx-org/eryx/pull/56))
...
## `eryx-precompile` - [0.3.0](https://github.com/eryx-org/eryx/releases/tag/eryx-precompile-v0.3.0) - 2026-02-08

### Added
- add eryx-precompile CLI binary

### Fixed
- *(eryx-precompile)* remove embedded feature dependency ([#51](https://github.com/eryx-org/eryx/pull/51))
- replace expect() with ok_or_else() for clippy
- resolve CI failures for eryx-precompile

## `eryx` - [0.3.0](https://github.com/eryx-org/eryx/compare/eryx-v0.1.0...eryx-v0.3.0) - 2026-02-08

### Added
- *(output)* stream stdout/stderr in real-time via report-output WIT import ([#75](https://github.com/eryx-org/eryx/pull/75))
- *(volumes)* add host filesystem volume mounts ([#71](https://github.com/eryx-org/eryx/pull/71))
- *(python)* switch snapshot/restore serialization from pickle to dill ([#72](https://github.com/eryx-org/eryx/pull/72))
- *(js)* add JavaScript bindings via jco transpile ([#68](https://github.com/eryx-org/eryx/pull/68))
- *(secrets)* implement placeholder substitution for secure secrets management ([#58](https://github.com/eryx-org/eryx/pull/58))
- *(macros)* add #[callback] proc macro for simplified callback definitions ([#64](https://github.com/eryx-org/eryx/pull/64))

### Fixed
- *(timeout)* interrupt blocking WASI calls like time.sleep() promptly ([#73](https://github.com/eryx-org/eryx/pull/73))
- *(eryx-precompile)* remove embedded feature dependency ([#51](https://github.com/eryx-org/eryx/pull/51))

## `eryx-vfs` - [0.3.0](https://github.com/eryx-org/eryx/releases/tag/eryx-vfs-v0.3.0) - 2026-02-08
...
## `eryx-runtime` - [0.3.0](https://github.com/eryx-org/eryx/releases/tag/eryx-runtime-v0.3.0) - 2026-02-08
...
## `eryx-macros` - [0.3.0](https://github.com/eryx-org/eryx/releases/tag/eryx-macros-v0.3.0) - 2026-02-08
